  ...
  <main class="mi-cuenta">
    <div class="wrapper" v-if="usuarioCarroCompra()">
      ...
      <div class="columns is-variable is-4-tablet mt-4">
        ...
        <div class="column">
          <h2 class="primero">
            <strong>Bienvenid@!.</strong> Aquí puedes gestionar tu información personal y
            pedidos.
          </h2>
          <div class="message mt-4 is-ecomas">
            <div class="message-header">
              ...
              <a
                href="#"
                @click.prevent="
                  informacion_personal.editar = !informacion_personal.editar
                "
            ...
            <div class="message-body">
              <div
                class="columns is-multiline is-variable is-6-desktop is-1-mobile"
                v-if="!informacion_personal.editar"
              >
                <div class="column is-narrow">
                  <strong class="primero">Nombre: </strong>
                  <strong>{{ usuarioCarroCompra().user_first_name }}</strong>
                </div>
                <div class="column is-narrow">
                  <strong class="primero">Apellidos: </strong>
                  <strong>{{ usuarioCarroCompra().user_last_name }}</strong>
                </div>
              </div>
              <form
                action="#"
                @submit.prevent="actualizarInformacionPersonal(1)"
                v-if="informacion_personal.editar"
              >
                  ...
                  <div class="column">
                    <div class="field">
                      ...
                      <input
                        type="text"
                        class="input"
                        v-model="informacion_personal.first_name"
                      />
                    </div>
                  </div>
                  <div class="column">
                    <div class="field">
                      <label for="" class="primero has-text-weight-bold"
                        >Apellido Paterno</label
                      >
                      <input
                        type="text"
                        class="input"
                        v-model="informacion_personal.apellido_paterno"
                      />
                    </div>
                  </div>
                  <div class="column">
                    <div class="field">
                      ...
                      <input
                        type="text"
                        class="input"
                        v-model="informacion_personal.apellido_materno"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div class="field has-text-right">
                  <button
                    type="submit"
                    class="button button-2 bg-primero"
                    v-if="!informacion_personal.cargando"
                  >
                    Actualizar
                  </button>
                  <CargandoSeccion
          ...
          <div class="message mt-4 is-ecomas">
            <div class="message-header">
              ...
              <a
                href="#"
                @click.prevent="billing.editar = !billing.editar"
                class="has-text-weight-normal is-size-7"
                ><i class="fa-regular fa-pen-to-square"></i> Editar</a
              >
            </div>
            <div class="message-body">
              <div class="columns is-multiline">
                <div class="column is-narrow">
                  <strong class="primero">Teléfono: </strong>
                  <strong>{{ usuarioCarroCompra().billing.phone }}</strong>
                </div>
                <div class="column is-narrow">
                  <strong class="primero">Email: </strong>
                  <strong>{{ usuarioCarroCompra().user_email }}</strong>
                </div>
              </div>

              <form
                action="#"
                @submit.prevent="actualizarBilling(1)"
                v-if="billing.editar"
              >
          ...
          <div class="message mt-4 is-ecomas">
            <div class="message-header">
              ...
              <a
                href="#"
                @click.prevent="password.editar = !password.editar"
                class="has-text-weight-normal is-size-7"
                ><i class="fa-regular fa-pen-to-square"></i> Editar</a
              >
            </div>
            <div class="message-body">
              <div class="columns is-multiline">
                ...
                <div class="column is-narrow">
                  <strong class="primero">Confirmar Contraseña: </strong>
...
export default {
  ...
  beforeMount() {
    if (!this.usuarioCarroCompra()) this.$router.replace({ path: "/ingresar" });
  },
  mounted() {
    ...
    this.informacion_personal.apellido_paterno = this.usuarioCarroCompra()
      ? this.usuarioCarroCompra().user_last_name.split(" ")[0]
      : "";
    this.informacion_personal.apellido_materno = this.usuarioCarroCompra()
      ? this.usuarioCarroCompra()?.user_last_name.split(" ")[1]
      : "";
    this.billing.phone = this.usuarioCarroCompra()
  ...
  methods: {
    async actualizarInformacionPersonal() {
      ...
      const respuesta = await this.actualizar_usuario({
        ...
        last_name:
          this.informacion_personal.apellido_paterno +
          " " +
          this.informacion_personal.apellido_materno,
