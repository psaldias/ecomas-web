    ...
    */
    ...
    export default {
        ...
        watch: {
            ...
            'latLongBounds.latLng':function(newVal, oldVal) {
              if(this.latLongBounds.latLng){
                var latLng = new google.maps.LatLng(this.latLongBounds.latLng);
                var defaultBounds = new google.maps.LatLngBounds(
                new google.maps.Circle({center: latLng, radius: this.latLongBounds.radius}).getBounds()
                );
