<template>
  <div
    ...
    v-if="
      store_opciones_generales.ingreso_con_google.activo &&
      store_opciones_generales.ingreso_con_google.id
    "
  >
...
export default {
  ...
  async mounted() {
    if (
      this.store_opciones_generales.ingreso_con_google.activo &&
      this.store_opciones_generales.ingreso_con_google.id
    ) {
