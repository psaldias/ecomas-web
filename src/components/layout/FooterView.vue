    ...
    <div class="wrapper">
      <div class="columns is-centered is-mobile is-multiline">
        <div class="column is-narrow-desktop is-12-mobile has-text-centered">
          <router-link to="/">
            <img src="/img/Ecomas-Logo-footer.png" alt="Ecomas" width="228" height="68" />
          </router-link>

          <div
            class="has-text-centered rrss is-narrow mt-4"
        ...
        <div
          class="column is-narrow-desktop is-12-mobile px-4"
          v-if="
            !store_opciones_generales.cargando && store_opciones_generales.telefono_footer
          "
        ></div>
        <div
          class="column is-narrow-desktop is-align-self-center has-text-centered-mobile"
          v-if="
            !store_opciones_generales.cargando && store_opciones_generales.telefono_footer
          "
        >
          <a
            :href="'tel:' + store_opciones_generales.telefono_footer"
            class="button is-rounded button-fono has-text-white"
          >
            <b
              ><i class="fa-solid fa-phone-volume primero"></i>
