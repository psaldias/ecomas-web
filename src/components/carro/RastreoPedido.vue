<template>
  <div class="card seguimiento mb-4">
    <div
      class="columns is-gapless pasos has-text-centered is-centered"
      v-if="!cargando && seguimiento && seguimiento.code == 200"
    >
      <div
        class="column is-3-desktop is-12-mobile"
        :class="{
          active:
            !seguimiento ||
            !seguimiento.data ||
            parseInt(seguimiento.data.U_SEI_ESTADO) <= 2,
        }"
      >
        <div class="numero">
          <span>1</span>
      ...
      <div
        class="column is-3-desktop is-12-mobile"
        :class="{ active: seguimiento && seguimiento.data.U_SEI_ESTADO == '3' }"
      >
        <div class="numero">
          <span>2</span>
        </div>
      ...
      <div
        class="column is-3-desktop is-12-mobile"
        :class="{ active: seguimiento && seguimiento.data.U_SEI_ESTADO == '4' }"
      >
        <div class="numero">
          <span>3</span>
        </div>
        ...
        <div v-if="seguimiento && seguimiento.data.U_SEI_ESTADO == '4'">
          <p>
            ...
            {{ seguimiento.data.UpdateDate }} a las {{ seguimiento.data.UpdateTime }}
          </p>
        </div>
      </div>
      <div
        class="column is-3-desktop is-12-mobile"
        :class="{ active: seguimiento && seguimiento.data.U_SEI_ESTADO == '5' }"
      >
        <div class="numero">
          <span>4</span>
        </div>
        ...
        <div v-if="seguimiento && seguimiento.data.U_SEI_ESTADO == '5'">
          <p>
            Tu pedido fue entregado con éxito<br />
            {{ seguimiento.data.UpdateDate }} a las {{ seguimiento.data.UpdateTime }}
          </p>
        </div>
      </div>
