...
### v1.2.1
Actualizacion seguimientos de pedido.
...
- En la pestaña Instalación, se agregaron botones Manual de usuario y Manual de instalación
- En las pestañas "características", "Ficha técnica" e "Instalación" se quitaron los títulos dentro de la caja de texto.
- Se eliminó el subrayado de la ubicación en la cabecera.
...
- Agregar toplayer cuando se agrega un producto de compra rapida al "carrito"
- Agregar datos de facturación al formulario de compra rápida
- En el interior de un producto
  - Nuevo Slider de imagenes bajo detalle del producto
  - Nueva pestaña "Instalación"
