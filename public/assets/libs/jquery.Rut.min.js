(function ($) {
    jQuery.fn.Rut = function (options) {
        var defaults = { digito_verificador: null, on_error: function () {}, on_success: function () {}, validation: true, format: true, format_on: "change" };
...
jQuery.Rut = {
    ...
    digitoCorrecto: function (crut) {
        ...
        let dvr = jQuery.Rut.getDigito(rut);
